...
class FixSettingsGroups extends Command
{
    ...
    public function handle()
    {
        $settings = [
            ...
            ['key' => 'about_hero_title', 'group' => 'about_page'],
            ['key' => 'about_hero_subtitle', 'group' => 'about_page'],
            ['key' => 'about_hero_image', 'group' => 'hero_backgrounds'],
            ['key' => 'about_content', 'group' => 'about_page'],
            ['key' => 'contact_hero_title', 'group' => 'support_info'],
            ['key' => 'contact_hero_subtitle', 'group' => 'support_info'],
            ['key' => 'support_email', 'group' => 'support_info'],
            ['key' => 'support_phone', 'group' => 'support_info'],
            ['key' => 'office_address', 'group' => 'support_info'],
            ['key' => 'investors_hero_title', 'group' => 'market_narratives'],
            ['key' => 'investors_hero_subtitle', 'group' => 'market_narratives'],
            ['key' => 'investors_hero_image', 'group' => 'hero_backgrounds'],
            ['key' => 'commercial_hero_title', 'group' => 'market_narratives'],
            ['key' => 'commercial_hero_subtitle', 'group' => 'market_narratives'],
            ...
            ['key' => 'cooperatives_hero_title', 'group' => 'market_narratives'],
            ['key' => 'cooperatives_hero_subtitle', 'group' => 'market_narratives'],
            ...
            ['key' => 'blog_hero_title', 'group' => 'market_narratives'],
            ['key' => 'blog_hero_subtitle', 'group' => 'market_narratives'],
