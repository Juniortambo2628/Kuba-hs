        ...
        {showChat ? (
          <div className="p-4 sm:p-8 bg-white dark:bg-zinc-950">
            <div className="flex items-center justify-between mb-4 px-4">
              ...
              <h2 className="font-black text-[#1E293B] dark:text-white uppercase tracking-tighter">Secure Chat</h2>
            </div>
          ...
          <>
            ...
            <div className="p-8 sm:p-12 space-y-8 bg-white dark:bg-zinc-900">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-1.5 border border-gray-100 dark:border-white/5 p-6 rounded-2xl bg-gray-50/50 dark:bg-zinc-950/50">
                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 flex items-center gap-2">
                            <User className="w-4 h-4 text-indigo-500" /> Professional
                        </p>
                        <p className="font-black text-lg text-[#1E293B] dark:text-white mt-2">
                            {booking.provider?.business_name || booking.provider?.user?.first_name || 'Assigned Pro'}
                        </p>
                    </div>
                </div>
                ...
                {booking.description && (
                    <div className="space-y-2">
                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Your Instructions</p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 border-t border-gray-100 dark:border-white/5">
                    {booking.status === 'pending' && (
                        <Button 
                            ...
                            variant="outline"
                            className="w-full sm:flex-1 h-14 border border-rose-100 dark:border-rose-900 bg-white dark:bg-transparent text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 rounded-2xl font-black text-[10px] sm:text-xs uppercase tracking-widest transition-all gap-2"
                        >
