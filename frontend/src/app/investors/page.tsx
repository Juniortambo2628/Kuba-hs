    ...
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white font-sans transition-colors duration-300">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-xs font-semibold tracking-wider text-indigo-600 dark:text-indigo-400 uppercase bg-indigo-500/10 border border-indigo-500/20 rounded-full">
              Investor Relations
            </span>
      ...
      {/* Stats/Metrics */}
      <section className="py-20 bg-gray-50/50 dark:bg-zinc-950/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: "Active Users", value: getS('investor_page', 'investor_metric_users', "250K+"), icon: Users },
              { label: "Monthly Revenue", value: getS('investor_page', 'investor_metric_revenue', "$1.2M"), icon: TrendingUp },
              ...
              <motion.div 
                ...
                className="text-center p-6 border border-gray-100 dark:border-white/5 rounded-2xl bg-white dark:bg-white/5 backdrop-blur-sm shadow-sm"
              >
                <stat.icon className="w-6 h-6 mx-auto mb-4 text-indigo-600 dark:text-indigo-500" />
                <div className="text-3xl font-bold mb-1">{stat.value}</div>
                <div className="text-[10px] text-gray-500 dark:text-gray-500 uppercase tracking-widest font-black">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {getS('investor_page', 'investor_thesis_points', "Verified professional network using proprietary trust scoring\nAutomated dispatching and dynamic pricing engines\nUnified financial layer for payments and escrow\nHyper-local expansion model with high operational efficiency")
                  ...
                  .map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm text-gray-500 dark:text-gray-300">
          ...
          {/* Contact Form */}
          <div id="contact-form" className="bg-white dark:bg-[#111] p-10 rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-2xl relative overflow-hidden transition-all duration-300">
            {submitted ? (
              <motion.div 
              ...
              >
                ...
                <Button 
                  ...
                  variant="outline"
                  className="mt-8 border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 rounded-xl uppercase font-black text-[10px] tracking-widest px-8 h-12"
                >
              ...
              <>
                <div className="mb-10 text-center lg:text-left">
                  <h3 className="text-2xl font-black text-[#1E293B] dark:text-white uppercase tracking-tight mb-2">Connect with Us</h3>
                  <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em]">Please provide your details below.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4 text-left">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        required
                        className="bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 h-14 rounded-2xl focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-500/20 text-sm font-bold"
                        value={formData.name}
                  ...
                  <div className="grid grid-cols-2 gap-4 text-left">
                    <div className="space-y-2">
                      <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Firm / Company</label>
                      <Input 
                    ...
                    <div className="space-y-2 text-left">
                      <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Investment Range</label>
                      <select 
                        className="flex h-14 w-full rounded-2xl border border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-white/5 px-4 py-2 text-sm font-bold focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-500/20 outline-none appearance-none transition-all dark:text-white"
                      ...
                      >
                        ...
                        <option value="$1M - $5M" className="bg-white dark:bg-black">$1M - $5M</option>
                        <option value="$5M - $20M" className="bg-white dark:bg-black">$5M - $20M</option>
                        <option value="$20M - $50M" className="bg-white dark:bg-black">$20M - $50M</option>
                        <option value="$50M+" className="bg-white dark:bg-black">$50M+</option>
                      </select>
                    </div>
                  </div>

                  <div className="space-y-2 text-left">
                    <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">Message / Interests</label>
                    <Textarea 
                      placeholder="Tell us about your area of interest..." 
                      className="bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 min-h-[140px] rounded-2xl focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-500/20 text-sm font-bold p-6"
                      required
                  ...
                  {error && (
                    <div className="p-4 bg-red-500/5 border border-red-500/10 text-red-500 text-[10px] font-black uppercase tracking-widest rounded-xl text-center">
                      {error}
                    </div>
                  )}
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-14 bg-[#1E293B] dark:bg-indigo-600 hover:bg-sky-600 dark:hover:bg-indigo-700 text-white font-black rounded-2xl shadow-xl shadow-gray-100 dark:shadow-indigo-900/10 transition-all uppercase tracking-widest text-[11px]"
