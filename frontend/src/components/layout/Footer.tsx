    ...
    <footer className="bg-gray-50 dark:bg-[#0B0F19] text-gray-900 dark:text-white py-12 border-t border-gray-200 dark:border-white/10 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="md:col-span-1">
                ...
                <span className="text-xl font-bold tracking-tight">Kuba</span>
                </Link>
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-6 leading-relaxed">
                Connect with trusted home service professionals in your area. Quick, reliable, and secure.
                </p>
                <div className="flex gap-4">
                <a href="#" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 transition-colors">
                    <Facebook className="w-4 h-4" />
                </a>
                <a href="#" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-400 transition-colors">
                    <Twitter className="w-4 h-4" />
                </a>
                <a href="#" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 transition-colors">
                    <Instagram className="w-4 h-4" />
                </a>
                <a href="#" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-700 transition-colors">
            ...
            <div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-4">For Customers</h3>
            ...
            <div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-4">For Providers</h3>
                <ul className="space-y-3">
            ...
            <div>
                ...
                <ul className="space-y-3">
                <li><button onClick={() => openLegalModal('terms')} className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors text-left w-full">Terms of Service</button></li>
                <li><button onClick={() => openLegalModal('privacy')} className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors text-left w-full">Privacy Policy</button></li>
