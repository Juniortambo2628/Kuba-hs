...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      className={cn(
        "file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-white/5 border-gray-200 dark:border-white/10 h-12 w-full min-w-0 rounded-xl border bg-white dark:bg-background px-4 py-2 text-base shadow-sm hover:border-gray-300 dark:hover:border-white/20 transition-all outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
