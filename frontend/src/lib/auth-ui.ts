...
export const authUi = {
  page: "min-h-screen bg-muted/30 dark:bg-background flex items-center justify-center p-4 sm:p-6 md:p-10",
  ...
  footerLink: "font-semibold text-teal-600 hover:underline underline-offset-2",
  socialStrip:
  ...
  visualClient: "bg-gradient-to-br from-teal-300 via-teal-400 to-teal-600",
  visualProvider: "bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-600",
  ...
  input:
    "h-12 pl-11 pr-11 rounded-xl border-border/70 bg-muted/30 text-sm font-medium focus-visible:ring-2 focus-visible:ring-teal-600/25",
