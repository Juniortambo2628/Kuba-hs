...
export const designSystem = {
  typography: {
    ...
    section: {
      badge: "inline-block px-4 py-1.5 mb-6 text-xs font-semibold tracking-wider text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 rounded-full uppercase",
      ...
      cardTitle: "text-xl font-bold uppercase tracking-tight",
      cardText: "text-gray-600 dark:text-muted-foreground leading-relaxed font-medium text-sm",
    },
    legal: {
      h1: "text-4xl font-bold tracking-tight mb-8 text-gray-900 dark:text-white uppercase leading-tight",
      h2: "text-xl font-bold mb-4 uppercase tracking-tight text-gray-900 dark:text-white",
      meta: "text-[10px] font-semibold text-muted-foreground tracking-widest uppercase",
      paragraph: "text-gray-600 dark:text-muted-foreground leading-relaxed font-medium",
    },
    auth: {
      h1: "text-3xl font-bold tracking-tight text-gray-900 dark:text-white uppercase leading-tight text-center lg:text-left",
      subtitle: "text-gray-600 dark:text-muted-foreground leading-relaxed font-medium italic mt-2 text-center lg:text-left",
      label: "text-[10px] font-semibold text-muted-foreground tracking-widest ml-1 uppercase",
      ...
      button: "w-full h-14 bg-primary dark:bg-indigo-600 hover:bg-primary/90 dark:hover:bg-indigo-700 text-white font-bold rounded-2xl shadow-xl transition-all tracking-widest text-[11px] uppercase",
    }
  },
  layouts: {
