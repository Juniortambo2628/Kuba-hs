  ...
  if (!user) {
    return (
        <div className={className}>
            <Link href="/login" className="text-sm font-medium hover:text-primary-6000 px-4 py-2">
                Login
            </Link>
            <Link href="/signup" className="text-sm font-medium bg-primary-6000 text-white px-4 py-2 rounded-full shadow-sm hover:bg-primary-700 transition-colors">
                Sign Up
            </Link>
        </div>
    );
    ...
    <Popover className={`AvatarDropdown relative flex ${className}`}>
        {({ open, close }) => (
          <>
            ...
            >
              <Avatar 
                imgUrl={getAvatarUrl(user.avatar_url)} 
                userName={user.name}
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs mt-0.5 capitalize">{user.role}</p>
                      </div>
                    </div>
                    ...
                    {/* ------------------ 2 --------------------- */}
                    <Link
                      href={`${getDashboardHref()}/bookings` as any}
                      className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                      onClick={() => close()}
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
