...
import { Dialog, DialogBackdrop, DialogPanel, DialogTitle, Popover, Tab, Transition, TransitionChild } from "@headlessui/react";
          ...
          >
            <div className="min-h-screen text-center">
              <TransitionChild
                ...
                leaveTo="opacity-0"
              >
                <DialogBackdrop className="fixed inset-0 bg-black bg-opacity-40 dark:bg-opacity-60" />
              </TransitionChild>
              ...
              >
                <DialogPanel className="inline-block py-8 px-2 h-screen w-full max-w-4xl inline-flex flex-col text-left align-middle transition-all transform overflow-hidden rounded-2xl bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100 shadow-xl h-full focus:outline-none">
