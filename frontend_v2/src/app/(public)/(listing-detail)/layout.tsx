...
import { imageGallery as listingStayImageGallery } from "./service-detail/[id]/constant";
...
const DetailtLayoutContent = ({ children }: { children: ReactNode }) => {
  ...
  const getImageGalleryListing = () => {
    if (thisPathname?.includes("/listing-stay-detail") || thisPathname?.includes("/service-detail")) {
