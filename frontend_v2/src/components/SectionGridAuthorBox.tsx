...
const SectionGridAuthorBox: FC<SectionGridAuthorBoxProps> = ({
  ...
  heading = "Featured Professionals",
  subHeading = "Top-rated service providers in Nairobi",
}) => {
  return (
    <div
    ...
    >
      ...
      <div className="mt-16 flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-5">
        <ButtonSecondary href="/providers">Show me more </ButtonSecondary>
        <ButtonPrimary href="/signup">Join as a Professional</ButtonPrimary>
      </div>
    </div>
  );
};
