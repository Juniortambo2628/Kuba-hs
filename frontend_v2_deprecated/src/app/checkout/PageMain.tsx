          ...
          <div className="mt-6">
            <TabGroup>
              <TabList className="flex my-5 gap-1">
                <Tab
                  className={({ selected }) =>
                    `px-4 py-1.5 sm:px-6 sm:py-2.5 rounded-full focus:outline-none ${
                        selected
                ...
                <Tab
                  className={({ selected }) =>
                    `px-4 py-1.5 sm:px-6 sm:py-2.5 rounded-full flex items-center justify-center focus:outline-none ${
                        selected
                          ? "bg-neutral-800 dark:bg-neutral-200 text-white dark:text-neutral-900"
                          : " text-neutral-6000 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"
                      }`
