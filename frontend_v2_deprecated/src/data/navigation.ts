    ...
    children: [
      {
        ...
        type: "dropdown",
        children: [
          { id: ncNanoId(), href: "/listing-service", name: "Service page" },
          { id: ncNanoId(), href: "/service-detail/1", name: "Service Detail" },
        ],
      },
...
export const NAVIGATION_DEMO_2: NavItemType[] = [
  ...
  //
  {
    ...
    name: "Listing pages",
    children: [
      { id: ncNanoId(), href: "/listing-service", name: "Service listings" },
      { id: ncNanoId(), href: "/service-detail/1", name: "Service detail" },
