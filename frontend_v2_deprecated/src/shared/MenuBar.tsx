...
import { Transition, Dialog, DialogBackdrop, DialogPanel, TransitionChild } from "@headlessui/react";
      ...
      <Transition appear show={isVisable} as={Fragment}>
        ...
        >
          <TransitionChild
            ...
            leaveTo="opacity-0"
          >
            <DialogBackdrop className="fixed inset-0 bg-black/60 dark:bg-black/70" />
          </TransitionChild>
